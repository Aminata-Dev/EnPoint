...
- add TTS to compare a phrase i say to a correct pronunciation. Mistral AI V. (march 2026) or EvenLabs. TTS live (comparaison) or variable -> audio (if I can't pronounce the phrase yet)
- Freestyle mode : I speak, auto fetcher get the IPA pronunciation
